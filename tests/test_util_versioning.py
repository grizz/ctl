...
@pytest.mark.parametrize("version,segment,expected", [
    ("1.2.3.4","major",(2,0,0)),
    ("1.2.3","minor",(1,3,0)),
    ("1.2.3.4","patch",(1,2,4)),
    ("1.2.3.4","dev",(1,2,3,5))
